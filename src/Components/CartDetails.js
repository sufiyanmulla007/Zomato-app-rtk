...
import { addToCart,removeToCart,removeSingleIteams,emptycartIteam } from '../Redux/Silce/Cartsilce';
...
const [totalquantity,setTotalQuantity] = useState(0);
  ...
  return (
    ...
    <h5 className='text-white m-0'>card calculation{carts.length >0 ? `(${carts.length})`:""}</h5>
    {
              ...
              carts.map((data,index)=>{
                return(
                  ...
                  <tr>
                    ...
                    <td><div className='product-img'><img src={data.imgdata} alt="pic" /></div></td>
